                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class='container' method="POST" action='add_biblio.php'>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="title_biblio" name='title_biblio' placeholder="Tytuł artykułu">
                                <label for="title_biblio">Tytuł artykułu</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="authors" name="authors" placeholder="Autorzy">
                                <label for="authors">Autorzy</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="doi" name='doi' placeholder="DOI"></input>
                                <label for="summary">DOI</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="year" name='year' placeholder="Rok wydania"></input>
                                <label for="year">Rok wydania</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="journal" name='journal' placeholder="Czasopismo"></input>
                                <label for="journal">Czasopismo</label>
                            </div>
